...
class ROS2Manager(Node):
    def __init__(self):
        ...
        self.arm_auto_control_publisher = self.create_publisher(
            String, "arm_auto_control_signal", 10
        )
    ...
    def publish_auto_arm_signal(self, command):
        msg = String()
        msg.data = command
        self.arm_auto_control_publisher.publish(msg)
